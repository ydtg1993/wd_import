...
class CollectionLabel extends Model
{
     ...
     * 标签名称-子
     *
     * @Column(name="name_child", prop="nameChild")
     *
     * @var string|null
     */
    private $nameChild;
     ...
     * 标签名称-临时
     *
     * @Column(name="name_temp", prop="nameTemp")
     *
     * @var string|null
     */
    private $nameTemp;
    ...
    /**
     * @param string|null $nameTemp
     *
     * @return self
     */
    public function setNameTemp(?string $nameTemp): self
    {
